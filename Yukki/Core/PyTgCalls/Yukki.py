        ...
        if Queues.is_empty(chat_id):
            ...
            if str(finxx) == "raw":
                ...
                finaltext = await app.send_photo(
                    ...
                    caption=f"📽️<b>**Started Streaming:**</b> {title} \n👥<b>**Requested by:** </b> {mention}",
                )
                await start_timer(
                    videoid,
                    duration_min,
                ...
                if int(quality) == 1080:
                    ...
                    finaltext = await app.send_photo(
                        ...
                        reply_markup=InlineKeyboardMarkup(buttons),
                        caption=(
                            f"**Video Streaming**\n\n📽️<b>**Started Playing:** </b>Next Video from Telegram \n👥**Requested by:** {mention}"
                        ),
                    )
                    await finaltext.delete()
                else:
                    ...
                    finaltext = await app.send_photo(
                        ...
                        reply_markup=InlineKeyboardMarkup(buttons),
                        caption=(
                            f"**Video Streaming**\n\n📽️<b>**Started Playing:** </b>[{title[:25]}](https://www.youtube.com/watch?v={afk}) \n👥**Requested by:** {mention}"
                        ),
                    )
                    os.remove(thumb)
                    await start_timer(
