            ...
            if str(finxx) == "raw":
                ...
                if int(quality) == 1080:
                    ...
                    final_output = await message.reply_photo(
                        ...
                        reply_markup=InlineKeyboardMarkup(buttons),
                        caption=(
                            f"‣‣I <b>Skipped Video Chat__</b>\n📽️ <b>Started Video Playing:</b> [{title[:25]}](https://www.youtube.com/watch?v={videoid}) \n👥 **Requested by:** {mention}"
                        ),
                    )
                    await mystic.delete()
                    os.remove(thumb)
