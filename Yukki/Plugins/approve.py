...
@app.on_message(filters.command("ok") & filters.user(SUDOERS))
...
@app.on_message(filters.command("no") & filters.user(SUDOERS))
...
@app.on_message(filters.command("oklist") & filters.user(SUDO_USERS))
