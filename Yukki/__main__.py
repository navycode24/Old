...
async def initiate_bot():
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("kynansupport")
            await ASS_CLI_1.join_chat("FamilyAlarick")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("kynansupport")
            await ASS_CLI_2.join_chat("FamilyAlarick")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("kynansupport")
            await ASS_CLI_3.join_chat("FamilyAlarick")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("kynansupport")
            await ASS_CLI_4.join_chat("FamilyAlarick")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("kynansupport")
            await ASS_CLI_5.join_chat("FamilyAlarick")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        try:
            ...
            return
        try:
            await LOG_CLIENT.join_chat("kynansupport")
            await LOG_CLIENT.join_chat("FamilyAlarick")
        except:
            pass
...
ᐉ **Title:** `{title}`
ᐉ **Duration:** `{duration}` Mins
ᐉ **Views:** `{views}`
ᐉ **Published Time:** `{published}`
ᐉ **Channel Name:** {channel}
ᐉ **Channel Link:** [Visit From Here]({channellink})
ᐉ **Video Link:** [Link]({link})
"""
